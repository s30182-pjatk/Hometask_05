...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(emp => depts.Where(dept => dept.Loc =="CHICAGO")
    ...
    public void ShouldSelectNamesAndSalaries()
    {
        ...
        var result = emps.Select(emp => new {EName = emp.EName, Sal = emp.Sal}).ToList(); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        // var result = emps.SelectMany(emp => emp.Comm, (emp, comm) => new {Comm = comm, Ename = emp.EName}).ToList();
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = from emp in emps
            ...
            where grade.Losal <= emp.Sal && grade.Hisal >= emp.Sal
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = from emp in emps
            ...
            into deptGroup
            select new { DeptNo = deptGroup.Key, AvgSal = deptGroup.Average(emp => emp.Sal) };
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = from emp in emps
                    let avgSal = (from empA in emps
                        where empA.DeptNo == emp.DeptNo
                        select empA.Sal).Average()
