...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnDistinctJobTitles()
    {
        ...
        var jobs = (from emp in emps 
                    group emp by emp.Job into groupJob
                    select groupJob.Key).Distinct(); 
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = from emp in emps
                    select new {EName = emp.EName, Total = (emp.Comm ?? 0) + emp.Sal};
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = from emp in emps
            ...
            from g in grades
            where g.Losal <= emp.Sal && g.Hisal >= emp.Sal
            select new
            {
                EName = emp.EName, DName = dept.DName, Grade = g.Grade
            }; 
